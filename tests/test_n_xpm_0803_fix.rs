...
fn test_n_xpm_0803_01_rejects_component_chain() {
    ...
    let file = File::open("test_suites/suite2_core_prod_matl/negative_test_cases/N_XPM_0803_01.3mf")
...
fn test_n_spx_0803_01_also_rejects_chain() {
    ...
    let file = File::open("test_suites/suite1_core_slice_prod/negative_test_cases/N_SPX_0803_01.3mf")
        .expect("Test file should exist");
